...
function buildAgentBrowserResultDetails(options: FinalResultInput, nextActions: AgentBrowserNextAction[] | undefined): Record<string, unknown> {
	...
	return {
		...
		forcedResult: options.processResult.forcedResult || undefined,
		forcedResultReason: options.processResult.forcedResultReason,
		processTreeCleanup: options.processResult.processTreeCleanup,
